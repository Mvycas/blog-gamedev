import { toggleIframe } from './toggleIframe.js';
...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <div>
        <iframe id="gameFrame" src="https://mvycas.github.io/Homework-RollABall/"
        ...
        <button id="toggleButton" onclick="toggleIframe()">Play Game</button>
    </div>
</div>
